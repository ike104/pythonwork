...
class mt4Hist(object):
    ...
    def getTimeFrame(self):
        """ get Time Frame """
        return self.period
    def getHeaderTimeSign(self):
        """ get Header time sign """
        return datetime.datetime.utcfromtimestamp(self.timesign)
    def getTime(self,index):
        """ get data time """
        return datetime.datetime.utcfromtimestamp(self.data[index][self.Time])
    def getOpen(self,index):
        """ get open """
        return self.data[index][self.Open]
    def getHigh(self,index):
        """get high """
        return self.data[index][self.High]
    def getLow(self,index):
        """ get low """
        return self.data[index][self.Low]
    def getClose(self,index):
        """ get close """
        return self.data[index][self.Close]
    def getVolume(self,index):
        """ get volume """
        return self.data[index][self.Volume]
    ...
    def outputHist(self, outputfilename = "outputtest.hst"):
        """ .hst output test """
...
def main():
    ...
    testhstname = hst.outputHist()
    
    # 新しくできた.hstを読み込んでみます
    testhst = mt4Hist(testhstname)
